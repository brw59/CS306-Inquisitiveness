 ...
 ***********************************************************************/
template <class T>
void sortMerge(T array[], int numOfNumbers)
{
...
*/
   ...
   // take all data in array and transfer to the new file
//      cout << "ERROR1!\n";

   output1.open("writeFile1.data");
   int tempIndex = sizeof(array) / sizeof(array[0]);
   while (count < numOfNumbers) //tempIndex)
   {
//      cout << count << " " << array[count] << " " << "tempIndex: " << tempIndex << " ";
//      cout << "ERROR2!\n";
      output1 << array[count++] << " ";
   }
...
/*
   output2.open("deleteme1.txt");
   input1.open("writeFile1.data");
   int  tempVariableNum;
   while (output2 >> tempVariableNum)
   {
//      cout << tempVariableNum;
      output2 << tempVariableNum << " ";
   }
   input1.close();
   output2.close();
*/
